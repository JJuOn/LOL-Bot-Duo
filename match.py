...
def matches():
    ...
    for file in files:
        ...
        for idx,gameId in enumerate(gameIds):
            ...
            team={}
            team['1']={'firstDragon':result['teams'][0]['firstDragon'],'win':1 if result['teams'][0]['win']=="Win" else 0}
            team['2']={'firstDragon':result['teams'][1]['firstDragon'],'win':1 if result['teams'][1]['win']=="Win" else 0}
            FTFlag=False
            for i in range(0,10):
